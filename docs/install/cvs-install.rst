...
.. code:: bash
     ...
     cvs copy-config inference/inferencex_atom/mi300x_inferencex-atom-single_gpt-oss-120b_bf16_config.json --output ~/my_inferencex_atom_config.json
     cvs copy-config inference/inferencex_atom/mi300x_inferencex-atom-single_gpt-oss-120b_bf16_threshold.json --output ~/my_inferencex_atom_threshold.json
