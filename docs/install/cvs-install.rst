...
1. Copy the InferenceX ATOM configuration files (main ``*.json`` and optional sibling ``*_threshold.json``):

.. code:: bash

     cvs copy-config inference/inferencex_atom/mi300x_inferencex-atom_gpt-oss-120b_bf16.json --output ~/my_inferencex_atom_config.json
     cvs copy-config inference/inferencex_atom/mi300x_inferencex-atom_gpt-oss-120b_bf16_threshold.json --output ~/my_inferencex_atom_threshold.json
