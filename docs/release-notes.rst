.. meta::
  :description: Release notes for Cluster Validation Suite (CVS) 0.2.0, covering new features, changes, and bug fixes since the previous release.
...
New cluster-wide observability is provided by the Cluster Health Monitor, with support for control-plane monitoring, RCCL RAS and Inspector plugins, and an nginx TLS overlay.
