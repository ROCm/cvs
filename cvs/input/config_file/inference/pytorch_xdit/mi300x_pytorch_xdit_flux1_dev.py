{
  ...
  "benchmark_params": {
    "flux1_dev_t2i": {
      ...
      "torchrun_nproc": 8,
      "expected_results": {
        "auto": { "max_avg_pipe_time_s": 12.0 },
        "mi300x": { "max_avg_pipe_time_s": 10.0 },
