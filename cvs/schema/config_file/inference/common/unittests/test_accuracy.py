"""Unit tests for AccuracyConfig / AccuracyTask (inference/common/accuracy.py)."""

import unittest

from pydantic import ValidationError

from cvs.schema.config_file.inference.common.accuracy import AccuracyConfig, AccuracyTask
