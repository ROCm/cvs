...
class TestPsshExec(unittest.TestCase):
    ...
    def test_exec_with_rocm_env(self, mock_pssh_client):
        ...
        self.log=MagicMock()
        pssh = Pssh(self.log, ["host1"], user="user", password="pass", module_name="rocm-test")
        ...
        mock_client.run_command.return_value = [mock_output]
    ...
    # ✅ NEW TEST for Module load
    def test_exec_without_rocm_env(self):
        self.pssh.module_name = None
        self.pssh.rocm_env = ""
...
class TestPsshExecCmdList(unittest.TestCase):
    ...
    def test_exec_cmd_list_with_rocm_env(self, mock_pssh_client):
        ...
        #pssh = Pssh("log", ["host1", "host2"], user="user", password="pass", module_name="rocm-test")
        self.host_list = ["host1", "host2"]
        self.mock_log = MagicMock()
        self.pssh = Pssh(self.mock_log, self.host_list, user="user", password="pass", module_name="rocm-test")
        cmd_list = ["echo h1", "echo h2"]
        ...
        mock_client.run_command.return_value = [mock_output1, mock_output2]
