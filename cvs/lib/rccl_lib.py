...
def rccl_cluster_test(
    ...
    cmd = orch.get_mpi_command(rank_cmd, mpi_runner_args, env_vars, mpi_install_dir)

    print('%%%%%%%%%%%%%%%%')
    print(f'MPI Runner Args: {mpi_runner_args}')
    ...
    try:
        out_dict = orch.distribute_using_mpi(rank_cmd, mpi_runner_args, env_vars, mpi_install_dir)
