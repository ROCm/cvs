...
MODEL_FLAVORS = {
    'llama3_1_8b':       {'name': 'llama3', 'flavor': '8B', 'module': 'llama3', 'model_size': '8B', 'tokenizer_path': 'meta-llama/Llama-3.1-8B', 'hf_assets_subdir': 'llama3'},
    'llama3_1_70b':      {'name': 'llama3', 'flavor': '70B', 'module': 'llama3', 'model_size': '70B', 'tokenizer_path': 'meta-llama/Llama-3.1-70B', 'hf_assets_subdir': 'llama3'},
    'llama3_1_405b':     {'name': 'llama3', 'flavor': '405B', 'module': 'llama3', 'model_size': '405B', 'tokenizer_path': 'meta-llama/Llama-3.1-405B', 'hf_assets_subdir': 'llama3'},
    'llama3_3_70b':      {'name': 'llama3', 'flavor': '70B', 'module': 'llama3', 'model_size': '70B', 'tokenizer_path': 'meta-llama/Llama-3.3-70B-Instruct', 'hf_assets_subdir': 'llama3'},
    'deepseek_v2_lite':  {'name': 'deepseek', 'flavor': 'lite', 'module': 'deepseek', 'model_size': 'lite', 'tokenizer_path': 'deepseek-ai/DeepSeek-V2-Lite', 'hf_assets_subdir': 'deepseek'},
    'deepseek_v3_16b':   {'name': 'deepseek_v3', 'flavor': '16b', 'module': 'deepseek_v3', 'model_size': '16b', 'tokenizer_path': 'deepseek-ai/DeepSeek-V3', 'hf_assets_subdir': 'deepseek'},
    'qwen3_32b':         {'name': 'qwen3', 'flavor': '32B', 'module': 'qwen3', 'model_size': '32B', 'tokenizer_path': 'Qwen/Qwen2.5-32B', 'hf_assets_subdir': 'qwen'},
    'mixtral_8x22b':     {'name': 'mixtral', 'flavor': '8x22B', 'module': 'mixtral', 'model_size': '8x22B', 'tokenizer_path': 'mistralai/Mixtral-8x22B-v0.1', 'hf_assets_subdir': 'mixtral'},
}
