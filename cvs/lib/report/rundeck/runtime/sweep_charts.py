    ...
    def render_bar_chart(
        ...
        *,
        ...
        for conc, val in points:
            ...
            point_label = f"C={conc}" if isinstance(conc, (int, float)) else str(conc)
            tip = html.escape(f"{point_label}: {fmt_num(val)} {unit}".strip())
            bars.append(
            ...
            x_labels.append(f"<span class='chart-xlbl'>{html.escape(point_label)}</span>")
        return (
