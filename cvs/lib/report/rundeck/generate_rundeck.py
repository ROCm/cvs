...
class RundeckPublisher:
    ...
    def _write_viewer(
        ...
        # Training suites use a dedicated, framework-generic viewer: per-tag line
        # charts (all sweeps overlaid) plotted dynamically from the embedded JSON,
        # not the inference concurrency viewer.
