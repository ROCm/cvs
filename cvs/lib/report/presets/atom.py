...
Per-suite inference report presets. **Reference:** ``atom.py``.
...
ATOM_REPORT_CONFIG = make_inference_report_config(
    suite_id="atom",
    report_basename="atom_run_deck",
    title="ATOM Run Deck",
    subtitle="ATOM \u00b7 lab performance summary",
    footer="CVS atom \u00b7 render-only \u00b7 does not affect gates",
    link_name="ATOM Run Deck",
    results_columns=ATOM_RESULTS_COLUMNS,
    ...
    chart_series=_ATOM_CHART_SERIES,
    inference_test_substring="test_atom_inference",
