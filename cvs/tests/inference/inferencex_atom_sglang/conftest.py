...
from cvs.lib.inference.utils.inferencex_atom_sglang_config_loader import (
    load_variant,
...
def orch(cluster_dict, variant_config, lifecycle):
    ...
    if not lifecycle.torn_down:
        log.info("orch fixture leak-guard: tearing down InferenceX SGLang parity containers")
...
def pytest_collection_modifyitems(items):
    rank = {
        ...
        "test_setup_sshd": 1,
        "test_model_fetch": 2,
        "test_inferencex_atom_sglang_inference": 3,
        "test_metric": 4,
