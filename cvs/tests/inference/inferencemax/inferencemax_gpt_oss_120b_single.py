...
Legacy InferenceMax suite (deprecated). Retained for gradual migration to
``cvs run inferencex_atom_single``. See ``cvs/input/config_file/inference/inferencemax/README.md``.
'''
