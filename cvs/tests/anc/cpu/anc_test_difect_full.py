...
Do NOT edit by hand. ANC single-group suite for the "difect_full" group (cpu).
...
ldconfig as pre-tasks, then runs the "difect_full" group; logs go to
{runner_log_folder}/anc_logs/<node>/test_difect_full/<timestamp>.
'''

from cvs.lib.anc_lib import AncGroupTest


class TestAncDifectFull(AncGroupTest):
    '''Run the single ANC group "difect_full".'''
