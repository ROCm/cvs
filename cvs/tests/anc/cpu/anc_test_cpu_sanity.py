...
Do NOT edit by hand. ANC single-group suite for the "cpu_sanity" group (cpu).
...
ldconfig as pre-tasks, then runs the "cpu_sanity" group; logs go to
{runner_log_folder}/anc_logs/<node>/test_cpu_sanity/<timestamp>.
'''

from cvs.lib.anc_lib import AncGroupTest


class TestAncCpuSanity(AncGroupTest):
    '''Run the single ANC group "cpu_sanity".'''
