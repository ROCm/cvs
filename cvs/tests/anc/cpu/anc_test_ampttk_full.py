...
Do NOT edit by hand. ANC single-group suite for the "ampttk_full" group (cpu).
...
ldconfig as pre-tasks, then runs the "ampttk_full" group; logs go to
{runner_log_folder}/anc_logs/<node>/test_ampttk_full/<timestamp>.
'''

from cvs.lib.anc_lib import AncGroupTest


class TestAncAmpttkFull(AncGroupTest):
    '''Run the single ANC group "ampttk_full".'''
