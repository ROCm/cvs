...
Do NOT edit by hand. ANC single-group suite for the "cpu_all" group (cpu).
...
ldconfig as pre-tasks, then runs the "cpu_all" group; logs go to
{runner_log_folder}/anc_logs/<node>/test_cpu_all/<timestamp>.
'''

from cvs.lib.anc_lib import AncGroupTest


class TestAncCpuAll(AncGroupTest):
    '''Run the single ANC group "cpu_all".'''
