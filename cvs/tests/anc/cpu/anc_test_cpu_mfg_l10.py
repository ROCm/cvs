...
Do NOT edit by hand. ANC single-group suite for the "cpu_mfg_l10" group (cpu).
...
ldconfig as pre-tasks, then runs the "cpu_mfg_l10" group; logs go to
{runner_log_folder}/anc_logs/<node>/test_cpu_mfg_l10/<timestamp>.
'''

from cvs.lib.anc_lib import AncGroupTest


class TestAncCpuMfgL10(AncGroupTest):
    '''Run the single ANC group "cpu_mfg_l10".'''
