...
The documentation for the JAX MaxText **test suites** now lives in the CVS docs
...
Library internals (developer notes) remain in
[`cvs/lib/training/jaxmaxtext/README.md`](../../../lib/training/jaxmaxtext/README.md).
