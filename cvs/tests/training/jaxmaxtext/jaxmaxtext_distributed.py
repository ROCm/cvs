...
JAX MaxText DISTRIBUTED (multi-node) training suite.

Run with a distributed config (training.distributed = true), e.g.:
...
metric-results HTML title, and loss-curve titles/artifacts.
'''
