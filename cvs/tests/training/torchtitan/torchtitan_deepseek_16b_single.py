...
def test_deepseek_16b_single_node(phdl, gpu_type, training_dict, model_params_dict, hf_token):
    """
    Pytest: Single-node TorchTitan DeepSeekMoE 16B training lifecycle test.
