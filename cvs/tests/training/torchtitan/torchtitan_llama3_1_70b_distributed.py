...
def test_llama_3_1_70b_distributed(phdl, gpu_type, training_dict, model_params_dict, hf_token):
    """
    Pytest: Multi-node TorchTitan Llama 3.1 70B training lifecycle test.
    ...
    Behavior:
      ...
      - Instantiates TorchTitanLlamaTrainingJob with distributed training enabled.
    ...
    """
    globals.error_list = []
    tt_obj = torchtitan_training_lib.TorchTitanLlamaTrainingJob(
        phdl,
        'llama3_1_70b',
        training_dict,
        model_params_dict,
