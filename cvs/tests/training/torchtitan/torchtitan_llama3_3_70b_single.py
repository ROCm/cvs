...
def test_llama_3_3_70b_single_node(phdl, gpu_type, training_dict, model_params_dict, hf_token):
    """
    Pytest: Single-node TorchTitan Llama 3.3 70B training lifecycle test.
