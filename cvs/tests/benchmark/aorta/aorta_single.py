"""Aorta single benchmark with one test per lifecycle stage.

Usage:
    cvs run aorta_single --cluster_file cluster.json \
        --config_file mi3xx_aorta_profile_overlap_2gpu_single.json
