...
- Atom has zero accuracy today — [`cvs/tests/inference/atom/atom.py`](../cvs/tests/inference/atom/atom.py)
  only runs perf (`test_atom_inference` + `test_cell_metrics`); no `accuracy` block in
  [`atom_config_loader.py`](../cvs/lib/inference/atom/atom_config_loader.py).
- CVS already landed a generic lm-eval path — [`test_accuracy_eval`](../cvs/lib/inference/utils/inference_suite_lifecycle.py)
  + [`AccuracyConfig`](../cvs/lib/inference/utils/accuracy_config.py) +
  [`run_accuracy_tasks`](../cvs/lib/inference/utils/lm_eval_job.py) are wired on **vLLM**, not atom.
  Prefer this over the older SGLang `run_gsm8k_benchmark_test` pattern.
