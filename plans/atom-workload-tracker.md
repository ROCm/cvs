...
| 10–11, 13–17, 19–21, 23 | V4, GLM 5.2, Qwen variants, etc. | P2 | Not included | — |
...
| 33 | Peak GPU memory | P2 | In progress — `platform.gpu_metrics_poll` → `gpu.peak_gpu_memory_mb` |
...
| Quant parity (#39) | Not included — ACC-7 |
| GSM8K / HellaSwag / MMLU-PRO (#45–46, #40) | In progress — ACC-1, ACC-14, ACC-15 on W1 `…_accuracy` |
| BBH, GPQA, MuSR, ARC, WinoGrande | Not included |
| Scale accuracy parity (#50) | Not included |
