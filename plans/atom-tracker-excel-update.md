...
cvs run atom \
  --cluster_file "$CLUSTER" \
  --config_file ~/input/config_file/inference/atom/single/mi300x_atom_kimi-k2.7-code_single.json \
  -k "w13_1k_1k-conc128" \
...
| 12  | Workload | Kimi K2.6 Thinking – uniquealexx/Kimi-K2.6-Thinking-200x, TP=4 (INT4)        | P2       | **Completed**     | `mi{300,355}x_atom_kimi-k2.6-thinking_{single,accuracy}`. **Lab pending.**                                                                                                                      |
...
| 14  | Workload | Kimi K2.5 MXFP4 – amd/Kimi-K2.5-MXFP4, TP=4                                  | P2       | **Completed**     | `mi{300,355}x_atom_kimi-k2.5-mxfp4_single`. **Lab pending.**                                                                                                                                    |
...
| 18  | Workload | Kimi-K2.7-Code – moonshotai/Kimi-K2.7-Code, TP=8 (MXFP4)                     | P1       | **Completed**     | **Highest P1 workload lab priority.** `mi{300,355}x_atom_kimi-k2.7-code_{single,longctx_single,code_accuracy}`. ACC-12 NIAH on accuracy stem. **Lab pending.**                                 |
