...
type Store interface {
	...
	// Clear removes the saved inventory document. Idempotent; does not delete
	// uploaded SSH keys (those live under KeyStore).
	Clear() error
}
...
// Clear removes the persisted inventory file and drops the in-memory copy.
