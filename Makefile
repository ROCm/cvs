...
.PHONY: all help build test-venv cvs-venv install installtest ut test clean_test_venv clean_cvs_venv clean_build clean_pycache clean
...
clean: clean_test_venv clean_cvs_venv clean_ruff_venv clean_build clean_pycache
